...
$(window).load(function() {
    ...
    var i = function(e) {
        for (var t = function(e) {
                for (var t = e.childNodes, i = t.length, o = [], n, r, l, a, s = 0; i > s; s++) n = t[s], 1 === n.nodeType && (r = n.children[0], l = r.getAttribute("data-size").split("x"), a = {
                    src: r.getAttribute("href"),
                    w: parseInt(l[0], 10),
                    h: parseInt(l[1], 10)
                }, n.children.length > 1 && (a.title = n.children[1].innerHTML), r.children.length > 0 && (a.msrc = r.children[0].getAttribute("src")), a.el = n, o.push(a));
                return o
            }, i = function c(e, t) {
                ...
                if (o) {
                    for (var n = o.parentNode, l = o.parentNode.childNodes, a = l.length, s = 0, d, c = 0; a > c; c++)
                        if (1 === l[c].nodeType) {
                            if (l[c] === o) {
                                d = s;
                                break
                ...
                isNaN(a.index) || (o && (a.showAnimationDuration = 0), l = new PhotoSwipe(r, PhotoSwipeUI_Default, s, a), l.init())
            }, l = document.querySelectorAll(e), a = 0, s = l.length; s > a; a++) l[a].setAttribute("data-pswp-uid", a + 1), l[a].onclick = o;
        var d = n();
